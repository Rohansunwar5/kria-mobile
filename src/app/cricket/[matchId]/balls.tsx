...
function BallRow({ b }: { b: DisplayBall }) {
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        {wicket ? (
          <Text style={{ fontFamily: 'Anton_400Regular', textTransform: 'uppercase', fontSize: 15, lineHeight: 18, color: '#FF4438' }}>
            Wicket
          </Text>
        ) : null}
        {b.commentary ? (
...
export default function CricketBalls() {
  ...
  const Header = (
    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16, paddingTop: 8, paddingBottom: 12, borderBottomWidth: 1.5, borderBottomColor: 'rgba(255,255,255,0.12)' }}>
      ...
      <View style={{ flex: 1 }}>
        <Text style={{ fontFamily: 'Anton_400Regular', textTransform: 'uppercase', fontSize: 17, lineHeight: 21, color: '#fff' }}>Ball by ball</Text>
